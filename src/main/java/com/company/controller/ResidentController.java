...
public class ResidentController {
    ...
    public ResidentDTO moveInResident(@PathVariable Integer residentId, @RequestParam(required = false) Integer apartmentId,
                                      @RequestBody ResidentForm form) throws Exception {
