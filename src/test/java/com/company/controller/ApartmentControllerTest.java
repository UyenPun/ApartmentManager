...
class ApartmentControllerTest {
    ...
    void testCountApartments() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(get("/api/v1/apartments/count"))
    ...
    void testGetAllApartments() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/apartments")
                        .param("page", "0")     // Passing page number as a request parameter
                        .param("size", "10"))    // Passing page size as a request parameter
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.content").isArray())  // Asserting the content is an array
